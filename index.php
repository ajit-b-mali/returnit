...
// // ROUTING LOGIC:
// // If the user is logged in, you usually want to show them the dashboard, 
// // not the marketing landing page.
// if (isset($_SESSION['user_id'])) {
//     // You can either include the dashboard file here or redirect
//     // header("Location: dashboard.php"); 
//     // exit;
    
//     // For this demo, let's assume this file handles both, but we will 
//     // strictly render the LANDING PAGE below for non-authenticated users.
//     // If you are pasting this into your project, uncomment the redirect above
//     // or put your dashboard logic here.
//     echo "<h1>Welcome back! (Redirecting to dashboard...)</h1>"; 
//     // header("Location: dashboard.php"); // Uncomment in production
//     exit;
// }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>ReturnIt - The Personal Lending Manager</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <div class="flex-shrink-0 flex items-center gap-2 cursor-pointer" onclick="window.scrollTo(0,0)">
                    ...
                    <span class="font-display font-bold text-2xl tracking-tight text-slate-900">ReturnIt</span>
                </div>

                <div class="hidden md:flex items-center space-x-8">
                    <a href="#features" class="text-slate-600 hover:text-primary font-medium transition">Features</a>
                    <a href="#how-it-works" class="text-slate-600 hover:text-primary font-medium transition">How it Works</a>
                    
                    <div class="flex items-center gap-4 pl-4 border-l border-slate-200">
                        <a href="login.php" class="text-slate-900 font-semibold hover:text-primary transition">Log in</a>
                        <a href="register.php" class="px-5 py-2.5 bg-slate-900 text-white font-medium rounded-full hover:bg-primary transition-all duration-300 shadow-lg hover:shadow-primary/25 transform hover:-translate-y-0.5">
                            Get Started
                        </a>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center mb-8">
                <div class="flex items-center gap-2 mb-4 md:mb-0">
                    <div class="w-8 h-8 bg-gradient-to-br from-primary to-secondary rounded flex items-center justify-center text-white font-bold">R</div>
            ...
            <div class="border-t border-slate-200 pt-8 text-center text-slate-400 text-sm">
